...
class QueryBuilder:
    ...
    def construct_get_all_classes_query(self, class_property='wdt:P31', class_identifer = "", class_additional_filter_string=[], class_limit = 0,):
        # 
        ...
        -class_limit: int, limit for maximum number of classes to query
        ...
        limit_string = ""
        if class_limit > 0:
            limit_string = "LIMIT {}".format(class_limit)
